...
-- detect redeclaration of same local variable in same scope
...
function Compiler:findIfLocal(name)
	...
	-- Search backw2ards to suport shadowing. Innermost scope's version of local variable found first
	for i = #tmp,1,-1 do
